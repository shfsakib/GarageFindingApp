...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row pad-all">
        <div class="col-12 col-md-12 align-items-center">
            <div class="col-xs-8 col-md-3" style="margin: 0; padding: 0 0 0 15px;">
            ...
            <div class="col-xs-4 col-md-1" style="margin: 0; padding: 0 15px 0 5px;">
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="table-responsive" style="border: none;">
                    <asp:GridView ID="gridbook" Width="100%" class="table table-hover table-bordered table-striped" Style="background: #ededfb;" OnRowDataBound="gridbook_OnRowDataBound" OnPageIndexChanging="gridbook_OnPageIndexChanging" AutoGenerateColumns="False" ShowHeader="False" ShowHeaderWhenEmpty="True" EmptyDataText="No Booking History Found" AllowPaging="True" PageSize="20" runat="server">
                        <Columns>
